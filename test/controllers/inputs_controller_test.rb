...
class InputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input" do
    assert_difference("Input.count") do
      post inputs_url, params: { input: { data: @input.data, kind_id: @input.kind_id, user_id: @input.user_id } }
    end
  ...
  test "should update input" do
    patch input_url(@input), params: { input: { data: @input.data, kind_id: @input.kind_id, user_id: @input.user_id } }
